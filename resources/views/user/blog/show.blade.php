						...
						<div class="p-r-45 p-r-0-lg">
							...
							<div class="p-t-32">
								...
								<span class="flex-w flex-m stext-111 cl2 p-b-19">
									...
									{{-- <span>
										Tags: {{ implode(', ', $post->tags->pluck('name')->toArray()) }} <!-- Nếu bạn có hệ thống tags cho bài viết -->
									</span> --}}
								</span>
									<!-- Ảnh bìa bài viết -->
							...
							{{-- <div class="mt-5">
								<a href="{{ route('user.blog.index') }}" class="btn btn-primary">Quay lại danh sách bài viết</a>
							</div> --}}
